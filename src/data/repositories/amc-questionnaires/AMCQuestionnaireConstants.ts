...
export const codesByComponentAMCQuestionnaire: Record<ComponentAMCQuestionId, string> = {
    ...
    unPopulation: "AMR_GLASS_AMC_DE_POP_UN",
    populationCovered: "AMR_GLASS_AMC_DE_POP_NAT",
    sourceOfNationalPopulation: "AMR_GLASS_AMC_DE_POP_NAT_SOURCE",
    nationalCoverage: "AMR_GLASS_AMC_DE_POP_NAT_COV",
    unPopulationCoverage: "AMR_GLASS_AMC_DE_POP_UN_COV",
...
export const ComponentAMCQuestionnaireByTEAIds: Record<Id, ComponentAMCQuestionId> = {
    ...
    d3sNTm3vBw1: "unPopulation",
    SQZJEgG9Xcc: "populationCovered",
    OZIjuHp6Zbw: "sourceOfNationalPopulation",
    t4TLGn8JdLS: "nationalCoverage",
    ls5b1NJtfUb: "unPopulationCoverage",
