                                ...
                                <Tooltip
                                    title={
                                        <>
                                            ...
                                            <Typography variant="caption">
                                                {i18n.t(
                                                    "IMPORTED - The data has been imported, but validations(if applicable) were not run successfully, in Step 2. In addition, in AMC the calculations have not been done yet or there has been some error in them."
                                                )}
                                                <br />
                                            </Typography>
                                            <Typography variant="caption">
