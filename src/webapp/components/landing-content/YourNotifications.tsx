            ...
            <CustomCard>
                ...
                <NotificationsList>
                    <Item>
                        ...
                        <p className="summary">
                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque mollis metus nisi, vel
                            ornare odio laoreet eu.{" "}
                        </p>
                        <button>
                            <ChevronRightIcon />
                        </button>
                    ...
                    <Item>
                        ...
                        <p className="summary">
                            Praesent ut imperdiet velit. Donec posuere lorem ac arcu vehicula luctus.
                        </p>
                        <button>
                            <ChevronRightIcon />
                        </button>
                    ...
                    <Item>
                        ...
                        <p className="summary">
                            Mauris pellentesque sit amet nisi sed mattis. Phasellus nulla nunc, tristique a orci sit
                            amet, consequat sagittis leo.
                        </p>
                        <button>
                            <ChevronRightIcon />
                        </button>
