    ...
    return (
        <MainLayout>
            <ContentWrapper>
                ...
                <p>currentNavItem: [&quot;{currentNavItem.groupName}&quot; , &quot;{currentNavItem.name}&quot;]</p>
                <p>module: {module}</p>
                <p>orgUnit: {orgUnit}</p>

                <Button variant="contained" color="secondary" onClick={() => setLoaded(!loaded)}>Toggle Loaded</Button>
                <Button variant="contained" color="primary" onClick={() => setIsDark(!isDark)}>Toggle Dark Header</Button>
                <hr />
