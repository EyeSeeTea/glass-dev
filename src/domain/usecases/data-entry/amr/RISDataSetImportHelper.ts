...
export class RISDataSetImportHelper extends AMRAggDataValuesImportHelper {
    ...
    static async initialize(
        ...
        const instance = new RISDataSetImportHelper(
            risDataRepository,
            metadataRepository,
        ...
        try {
            ...
            const [dataValuesResult, consistencyErrors] = await Promise.all([
                this.generateDataValues(
                    risDataItems,
                    RISDataSetImportHelper.risMetadataCache.risDataSet,
                    RISDataSetImportHelper.risMetadataCache.risDataSetAttrCombo,
                    orgUnitId,
                    10
                ),
            ...
            return await this.runPostSaveValidations(
                saveSummary,
                year,
                orgUnitId,
                allBlockingErrors,
    ...
    private runPreImportConsistencyChecks(risDataItems: RISData[], module: GlassModule): ConsistencyError[] {
