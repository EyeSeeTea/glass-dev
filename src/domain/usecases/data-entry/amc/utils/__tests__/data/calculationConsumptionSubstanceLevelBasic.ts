...
// Note: kilograms_autocalculated is undefined for all records because the test fixture
// (atcVersionsByKeys.json) does not carry DDD_GRAMS on its ddds entries.  The new formula
// derives kg as (ddds × DDD_GRAMS) / 1000; when DDD_GRAMS is absent it returns undefined
// rather than a stale tons_manual-based value.  Dedicated kg tests in the spec file below
// verify the formula with complete data that includes DDD_GRAMS.
export const calculationConsumptionSubstanceLevelBasic: SubstanceConsumptionCalculated[] = [
    {
        ...
        kilograms_autocalculated: undefined,
