import { isDefined } from "../../utils/ExcelReader";
...
export const executeExpression = (dhisFunctions, expression, logError) => {
    ...
    const onExpressionReplaceFunctionCallStringWithEvaluatedString = (
        { evaluatedExpression, isUpdated },
        { name, dhisFunction, parameters }
    ) => {
            ...
            for (let i = 0; i < 10 && continueLooping; i++) {
                const { evaluatedExpression, isUpdated } =
                    ...
                    Object.values(dhisFunctions)
                        ...
                        .reduce(onExpressionReplaceFunctionCallStringWithEvaluatedString, {
